...
<div class="logo_box">
  ...
  <form action="/reg" method="post" autocomplete="off">
    ...
    <div class="input_outer">
      ...
      <input maxlength="4" required="required" placeholder="Input verification code" name="code" class="text" type="text">
    </div>
    <div class="mb2">
      <button class="act-but submit" style="color: #FFFFFF">Register</button>
    </div>
  <#if error??>

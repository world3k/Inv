...
var columns = [[
    ...
    {title: '名称qq', field: 'catename', width: '30%', align: 'left', sortable: true},
    // {title: '父级id', field: 'pid', width: '11%', align: 'center', sortable: true},
    {title: '级别', field: 'level', width: '12%', align: 'left', sortable: true},
    {title: '链接地址', field: 'alink', width: '10%', align: 'left', sortable: true},
    {title: '排序', field: 'sort', width: '10%', align: 'left', sortable: true},
    {

...
var columns = [[
    ...
    {title: '积分ID', field: 'order_id', width: '12%', align: 'left', sortable: true},
    {title: '分发者', field: 'dist_user_id', width: '12%', align: 'left', sortable: true},
    {title: '接收者', field: 'receive_user_id', width: '12%', align: 'left', sortable: true},
    {title: '发放积分', field: 'dist_point', width: '12%', align: 'left', sortable: true},
    {title: '剩余积分', field: 'balance_point', width: '12%', align: 'left', sortable: true},

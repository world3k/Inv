...
var columns = [[
    ...
    {title: '提现分值', field: 'change', width: '6%', align: 'left', sortable: true},
    {title: '剩余积分', field: 'balance', width: '6%', align: 'left', sortable: true},
    {title: '级别', field: 'level', width: '6%', align: 'left', sortable: true},
    {title: '申请提现时间', field: 'create_time', width: '12%', align: 'left', sortable: true},
    {

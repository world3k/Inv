<form class="app-form" id="public_change_info_form">
  <div style="float: left;width: 250px">
    ...
    <div class="field">
      <input class="easyui-textbox" name="realName" style="width:80%" data-options="label:'name：',required:true" value="${s_member.realName}">
  ...
  <div style="margin-left: 250px;text-align: center;margin-top: 30px;">
    ...
    <#if s_member.avatar??>
      <img class="avatar-set" src="${s_member.avatar}" alt="Icon" width="80px" height="80px">
    <#else>
      <img class="avatar-set" src="/images/default.gif" alt="Icon" width="80px" height="80px">
    </#if>
    </div>
    <div>
      <a class="easyui-linkbutton">Upload Icon<input id="avatar-file" style="position: absolute;left: 0;opacity: 0;height: 100%;" type="file"></a>
    </div>
  </div>
</form>